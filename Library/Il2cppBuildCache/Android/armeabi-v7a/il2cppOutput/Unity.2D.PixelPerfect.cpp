...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCamera_PixelSnap_m91DD09A7F8EC7047E95D2853591589120C632549 (PixelPerfectCamera_tAEEA2988EBDE91F2C7D260CDA6B65FB24261CFE8 * __this, const RuntimeMethod* method)
{
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		...
		L_10 = Vector3_op_UnaryNegation_m56EB454031EABB53BA35FECF3F61A7E2332A2521_inline(L_9, /*hidden argument*/NULL);
		...
		L_13 = Matrix4x4_TRS_m5ABDD540D55BC20D1FD3804DDF005A867FC3D220(L_10, L_11, L_12, /*hidden argument*/NULL);
		V_2 = L_13;
		...
		L_19 = Matrix4x4_op_Multiply_mB760A95995CDC5E31F18D76CE8806DF2C160DD4B(L_15, L_18, /*hidden argument*/NULL);
		NullCheck(L_14);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCamera_Awake_m0EEA0D8C24DDBF0417409FC1ED92D46771038AF6 (PixelPerfectCamera_tAEEA2988EBDE91F2C7D260CDA6B65FB24261CFE8 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		Debug_LogWarning_mFCC4F73CACBC055EBB4CE9891F564B80B81B5F0E(_stringLiteral6E3C394542AFDC0953291817DE5BAA9A9329CF27, L_11, /*hidden argument*/NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCamera_OnPreRender_mF532865494E97AE563AEBE9B4496C9C1B55E87F4 (PixelPerfectCamera_tAEEA2988EBDE91F2C7D260CDA6B65FB24261CFE8 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		L_6 = Color_get_black_mD8CAAC9E4B8C5C92A21D176E4AB2C521CFA0EF7F(/*hidden argument*/NULL);
		GL_Clear_m012A79FD9FE6D463ACFF5B852E4399B00D4B365D((bool)0, (bool)1, L_6, /*hidden argument*/NULL);
	}
...
IL_0033:
	{
		...
		PixelPerfectRendering_set_pixelSnapSpacing_m452576A064958F45BDFF00A38520BDCCB937173C(L_8, /*hidden argument*/NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCamera_OnPostRender_m38D6AE9701187DACFC115503F17C6275AA176D43 (PixelPerfectCamera_tAEEA2988EBDE91F2C7D260CDA6B65FB24261CFE8 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		GL_Viewport_m8686A90C60315F1C5DE648B2D8BB250DF643272F(L_5, /*hidden argument*/NULL);
		// GL.Clear(false, true, Color.black);
		Color_tF40DAF76C04FFECF3FE6024F85A294741C9CC659  L_6;
		L_6 = Color_get_black_mD8CAAC9E4B8C5C92A21D176E4AB2C521CFA0EF7F(/*hidden argument*/NULL);
		GL_Clear_m012A79FD9FE6D463ACFF5B852E4399B00D4B365D((bool)0, (bool)1, L_6, /*hidden argument*/NULL);
...
IL_0089:
	{
		...
		int32_t L_20;
		L_20 = Screen_get_width_m44AD823DE1C2962E3B9CE69F680C6602034DC778(/*hidden argument*/NULL);
		int32_t L_21;
		L_21 = Screen_get_height_m71F7E12C4F33639042D80425D3169E288368C67A(/*hidden argument*/NULL);
		NullCheck(L_17);
...
IL_018e:
	{
		...
		L_53 = Rect_get_zero_m6FEB805768121953D08DC6A84A4DA3DBD3580B6E(/*hidden argument*/NULL);
...
IL_02ae:
	...
	}
	{
		...
		L_92 = Rect_get_zero_m6FEB805768121953D08DC6A84A4DA3DBD3580B6E(/*hidden argument*/NULL);
		bool L_93;
		L_93 = Rect_op_Equality_m4314500293279390A96F5121F17501A969554C32(L_91, L_92, /*hidden argument*/NULL);
		if (L_93)
		{
			goto IL_02dd;
		}
...
IL_031e:
	{
		...
		L_108 = Rect_get_zero_m6FEB805768121953D08DC6A84A4DA3DBD3580B6E(/*hidden argument*/NULL);
		bool L_109;
		L_109 = Rect_op_Equality_m4314500293279390A96F5121F17501A969554C32(L_107, L_108, /*hidden argument*/NULL);
		if (L_109)
		{
			goto IL_033d;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR float PixelPerfectCameraInternal_CorrectCinemachineOrthoSize_mCE913421BC4294451DC3869F2EB052D3B3802ED1 (PixelPerfectCameraInternal_t95E6E3E3BDA1D90E9F4489ED6B43D1673E0818AB * __this, float ___targetOrthoSize0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		float L_3 = ___targetOrthoSize0;
		int32_t L_4;
		L_4 = Mathf_RoundToInt_m95CE4916FFD8D1F8D87CF21A3C9EC257EBD8F578(((float)((float)L_2/(float)L_3)), /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Math_tA269614262430118C9FC5C4D9EF4F61C812568F0_il2cpp_TypeInfo_var);
		int32_t L_5;
		L_5 = Math_Max_m709673BDF5D9264E61FEBBC4CE1038752523838D(1, L_4, /*hidden argument*/NULL);
...
IL_0037:
	{
		...
		int32_t L_11;
		L_11 = Mathf_RoundToInt_m95CE4916FFD8D1F8D87CF21A3C9EC257EBD8F578(((float)((float)((float)il2cpp_codegen_multiply((float)((float)((float)L_8)), (float)L_9))/(float)L_10)), /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Math_tA269614262430118C9FC5C4D9EF4F61C812568F0_il2cpp_TypeInfo_var);
		int32_t L_12;
		L_12 = Math_Max_m709673BDF5D9264E61FEBBC4CE1038752523838D(1, L_11, /*hidden argument*/NULL);
